...
Try {
	...
	[string]$appName = 'Anaconda2'
	[string]$appVersion = '2019.10'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-Process -Path "Anaconda2-2019.10-Windows-x86_64.exe" -Parameters "/InstallationType=AllUsers /S /D=$env:ProgramData\Anaconda2"
